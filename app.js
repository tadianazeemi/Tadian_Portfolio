...
const portfolioItems = [
  ...
  // BRANDING
  { id:22, category:'branding', title:'JH Professional Card', desc:'Executive business card with refined layout and strong typographic hierarchy — premium feel in print.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Business Cards/JH business Card@4x-100.jpg', tag:'Business Card' },
  { id:23, category:'branding', title:'Brand Card — Front', desc:'Premium card front featuring bold brand colors, logo placement, and clean information architecture.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Business Cards/front@4x-100.jpg', tag:'Business Card' },
  { id:24, category:'branding', title:'Brand Card — Back', desc:'Sophisticated card reverse with brand pattern and contact details perfectly balanced for impact.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Business Cards/back@4x-100.jpg', tag:'Business Card' },
  ...
  // PRINT
  { id:26, category:'print', title:'Nutrition & Health Flyer', desc:'Vibrant promotional flyer for a health brand — engaging layout, strong color strategy, and clear hierarchy.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Flyers & Flexs/Nutrition Flyer@4x-100.jpg', tag:'Flyer Design' },
  { id:27, category:'print', title:'Quick Cart Standee 5×2ft', desc:'Large-format retail standee designed for maximum in-store visual impact and product promotion.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Flyers & Flexs/Quick Cart Standee 5 x 2@4x-100.jpg', tag:'Standee Design' },
  { id:28, category:'print', title:'Promotional Stand Flyer', desc:'High-visibility promotional flyer crafted for event displays with bold visual flow and brand awareness.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Flyers & Flexs/Stand Flyer@4x-100.jpg', tag:'Flyer Design' },
  // SOCIAL MEDIA
  { id:29, category:'social', title:'Carpet Wash Campaign', desc:'Eye-catching social media post for a cleaning services campaign with dominant color blocking and clear CTA.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Carpet Wash Post1@4x-100.jpg', tag:'Social Media' },
  { id:30, category:'social', title:'Discord Community Banner', desc:'Dynamic banner for a Discord server capturing community identity with modern gaming aesthetics.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Copy of Discord banner@4x-100.jpg', tag:'Banner Design' },
  { id:31, category:'social', title:'Wise Academy — FB Post', desc:'Educational social media post blending academic credibility with vibrant visual engagement for Facebook.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Wise Academy FB Post 2@4x-100.jpg', tag:'Social Media' },
  { id:32, category:'social', title:'Sofa Wash Promotion', desc:'Promotional social post for upholstery cleaning services with strong lifestyle visual appeal and CTA.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Sofa Wash Post2@4x-100.jpg', tag:'Social Media' },
  { id:33, category:'social', title:'Bonfire Café — Post 1', desc:'Warm, inviting café branding post with cozy aesthetics for social media marketing campaigns.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Bonfire_cafe_post_1.jpeg', tag:'Social Media' },
  { id:34, category:'social', title:'Bonfire Café — Post 2', desc:'Continuation of the Bonfire Café series — consistent brand voice with rich visual storytelling.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Bonfire_cafe_post_2.jpeg', tag:'Social Media' },
  { id:35, category:'social', title:'Bonfire Café — Post 3', desc:'Menu highlight post for Bonfire Café with appetite-driving photography and layout design.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Bonfire_cafe_post_3.jpeg', tag:'Social Media' },
  { id:36, category:'social', title:'Bonfire Café — Post 4', desc:'Brand awareness campaign post capturing café ambiance and lifestyle with compelling visual hierarchy.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Bonfire_cafe_post_4.jpeg', tag:'Social Media' },
  { id:37, category:'social', title:'Zeltham — Post 1', desc:'Tech brand social post with clean layouts and modern digital aesthetics for audience engagement.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Zeltham_post_1.jpeg', tag:'Social Media' },
  { id:38, category:'social', title:'Zeltham — Post 2', desc:'Product feature social media post for Zeltham with sharp product photography and layout.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Zeltham_post_2.jpeg', tag:'Social Media' },
  { id:39, category:'social', title:'Zeltham — Post 3', desc:'Brand value communication post with minimalist design language and bold messaging.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Zeltham_post_3.jpeg', tag:'Social Media' },
  { id:40, category:'social', title:'Zeltham — Post 4', desc:'Campaign wrap-up post for Zeltham combining data visuals with clean brand aesthetics.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Post Designs/Zeltham_post_4.jpeg', tag:'Social Media' },
  // PACKAGING
  { id:41, category:'packaging', title:'SA Fashion Packaging', desc:'Luxurious golden packaging design for a premium fashion brand — elegant, aspirational, and shelf-ready.', image:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Mockups & Packaging/SA Fashion Golden@3x.jpg', tag:'Packaging' },
];
...
const motionItems = [
  {
    ...
    video:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Logo Animations/Copy of Graphic Affect Logo Animation 0.mp4', tag:'After Effects'
  },
  {
    ...
    video:'https://raw.githubusercontent.com/tadianazeemi/Tadian_Portfolio/main/Logo Animations/Global Access Logo_1.mp4', tag:'Motion Graphics'
  },
];
